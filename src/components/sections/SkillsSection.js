...
import puntos from '../../assets/svg/puntos.svg'
import circle from '../../assets/svg/circle.svg'
import flechas from '../../assets/svg/flechas.svg'
import lineas from '../../assets/svg/lineas.svg'
...
export const SkillsSection = () => {
    return (
        ...
        <div className="contenedor-habilidades">
            <img src={circle} alt='line' className='img-svg svg-circle' />
            <img src={puntos} alt='line' className='img-svg puntos' />
            <img src={flechas} alt='line' className='flechas' />
            <img src={lineas} alt='line' className='lineas' />
            ...
            <div className="container">
                <div className="title">
                    <h1 className="uppercase"><FormattedMessage id="skills.title" defaultMessage="" /></h1>
                </div>
            </div>
            ...
            <div className="container tarjetas">
                <div className="row row-cols-1 row-cols-md-3 g-3">
                    <div className="col">
                        <div className="card h-100">
                            <div className="skill-icon">
                                <img src={'http://frontendtools.com/images/svg/html.svg'} className='svg' alt="svg"></img>                            </div>
                            <div className="card-body">
                                <h2 className="skill-subtitle">
                                    <FormattedMessage id="skills.development" defaultMessage="" />
                                </h2>
                                <div className="lista">
                                    <ul>
                                        <li>C/C++</li>
                    ...
                    <div className="col">
                        <div className="card h-100">
                            <div className="skill-icon">
                                <img src={'https://www.svgrepo.com/show/22166/database.svg'} className="svg" alt="svg" />
                            </div>
                            <div className="card-body">
                                <h5 className="skill-subtitle">
                                    <FormattedMessage id="skills.database" defaultMessage="" className="" />
                                </h5>
                                <div className="lista">
                                    <ul>
                                        <li>MongoDB</li>
